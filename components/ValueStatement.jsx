  ...
  return (
   <section className='w-full flex-center flex-col bg-picton-gallery mt-0 md:py-6'>
     ...
     <p className='desc_paragraphs text-greyhood md:text-center md:max-w-6xl font-normal'>
      We are a Network that understands the importance of being Caring, Respectful and Reliable.Our network from the personnel to partners work as a team with one mission and one goal: to make sure every service request is answered in a
