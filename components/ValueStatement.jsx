...
const ValueStatement = () => {
  return (
   <section className='w-full flex-center flex-col bg-picton-blue mt-0 md:py-6'>
     <h1 className='sect_head text-white text-center py-2 '>WHY RELIABLE TRANSIT LLC</h1>
     <p className='desc_paragraphs text-white md:text-center md:max-w-6xl font-normal'>
