  ...
  return (
    <section className="flex-center sm:py-16 py-6 flex-col relative ">
        ...
        <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb:16 mb-6 relative z-[1]">
          <h1 className="font-semibold xs:text-[48px] text-[20] md:text-[48px] text-picton-blue xs:leading-[76.8px] leading-[66.8px] w-full text-center">" WHAT OUR CLIENTS SAY "</h1>
