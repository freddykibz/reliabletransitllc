...
const ContactBlock = () => {
  return (
    <section className='flex-col w-full flex-center  md:flex-row bg-heroside-bg bg-repeat py-6 px-12 flex-between gap-4 shadow-sm '>
        ...
        <div>
        <h3 className="flex mt-2 flex-row gap-4 text-deluge md:font-medium md:text-xl"><BiPhone size='1.5rem'/><a className href="tel:+13128251175"></a>Phone: +(312) 825-1175</h3>
        </div>
        <div>
