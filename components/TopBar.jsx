...
const TopBar = () => {
  return (
    <div className='flex-col flex-center md:flex-row md:w-full  bg-gallery sticky top-0 left-0 right-0 md:z-10 '>
     <div className='flex gap-2 w-full flex-col md:flex-center  md:flex-row text-sm  font-normal '>
