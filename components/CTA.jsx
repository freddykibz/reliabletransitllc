...
const CTA = () => {
  return (
    <section className="flex-center flex-col md:flex-row marginY padding sm:flex-row  bg-picton-blue bg-cover rounded-[20px] vbox-shadow">
      ...
      <div className=" flex-1 flex-center sm:ml-10 ml-0 sm:mt-0 mt-4  md:mt-10">
        <button className="py-4 px-6 bg-white font-semibold rounded-full text-picton-blue uppercase">   
