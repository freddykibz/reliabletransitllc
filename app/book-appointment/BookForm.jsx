    ...
    <form  className="flex flex-col md:flex-row w-full" onSubmit={handleSubmit}>
        ...
        <div className='w-full flex flex-col md:flex-row gap-8 px-12 flex-center md: flex-start my-4'>
                ...
                <input 
                  ...
                  required 
                  className='px-3 py-4  w-full text-lg font-normal bg-gray-50 border-gray-300 md:w-3/5 shadow-sm focus:ouline-none focus:border-deluge focus:ring-1  focus:ring-picton-blue rounded-lg ' 
          ...
          <div className='w-full flex flex-col md:flex-row gap-8 px-12  flex-start my-4 '>
            ...
            <PhoneInput 
             ...
             onChange={setValue}
              ...
              maxLength={15}
              required 
              className=' w-full px-3 py-4 text-lg font-normal bg-gray-50 border-gray-300 md:w-3/5 shadow-sm focus:ouline-none focus:border-picton-blue focus:ring-1  focus:ring-picton-blue rounded-lg ' 
                id='phone' />
          </div>
        ...
        <div className='w-full flex-col md:flex-row gap-8 flex-start px-12 md:flex-start my-6 '>
         {/* <label className="hidden sm:block font-medium font-lg text-picton-blue mb-2 md:mx-8" htmlFor='comment'>Comment</label> */}
          <textarea 
            ...
            className='text-lg  font-normal px-6 py-4 bg-gray-50 border-gray-300 w-full md:w-2/3 shadow-sm focus:ouline-none focus:border-picton-blue focus:ring-1  focus:ring-picton-blue rounded-lg'
            id='comment'
          />
      </div>
